...
const Navigation = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full bg-dark-secondary/95 backdrop-blur-md border-b border-dark-accent z-50 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'
        }`}
    >
